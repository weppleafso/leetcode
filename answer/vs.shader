...
void main () {
	...
	// using Tint in sRGB+ gamma allows for more visually linear interpolation and to keep (0.5) at (128, gray in sRGB) point
	...
	if (eyeRay.y >= 0.0) {// Sky
		...
		//unthis rolling manually to avoid some platform for loop slow
		{
